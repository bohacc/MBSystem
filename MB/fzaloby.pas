...
type
  ...
  TfrmZaloby = class(TfrmSablona)
    ...
    qrMasterEXEKUCNI_PRIKAZ: TDateField;
    ...
    qrMasterOPRAVNE_USNESENI_DATUM: TDateField;
    ...
    qrMasterUSNESENI_DATUM: TDateField;
...
try
  ...
  if frmTiskZalob.rbVse.Checked then
    sql_text:='SELECT '+
              '  ROWNUM AS RADEK,'+
              '  Z.*,'+
              '  CEIL(NVL(Z.NAROK,0)-NVL(DLUZNA_CASTKA,0)) AS NAKLADY,'+
