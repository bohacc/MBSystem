...
type
  ...
  TfrmZaloby_Mlcoch = class(TfrmSablona)
    btEditace: TButton;
...
var
  frmZaloby_Mlcoch: TfrmZaloby_Mlcoch;
...
procedure TfrmZaloby_Mlcoch.btRefreshClick(Sender: TObject);
var
  b: TBookMarkStr;
begin
  inherited;
...
procedure TfrmZaloby_Mlcoch.btRefreshZpravyClick(Sender: TObject);
begin
  Refresh_DataSet(NavigatorZpravy.DataSource.DataSet,qrZpravy);
end;

procedure TfrmZaloby_Mlcoch.cbDatumyChange(Sender: TObject);
var
...
procedure TfrmZaloby_Mlcoch.DBGrid1DblClick(Sender: TObject);
begin
...
procedure TfrmZaloby_Mlcoch.DBGrid1PrepareCanvas(sender: TObject; DataCol: Integer;
  Column: TColumn; AState: TGridDrawState);
begin
...
procedure TfrmZaloby_Mlcoch.nastav_datumy;
var
  s: string;
  i : Integer;
begin
...
procedure TfrmZaloby_Mlcoch.btEditaceClick(Sender: TObject);
var
  sql_text,aID: string;
begin
  //try
...
procedure TfrmZaloby_Mlcoch.btPrijmoutPostuClick(Sender: TObject);
begin
  miPrijmoutPostu.Click;
end;

procedure TfrmZaloby_Mlcoch.DBGridDblClick(Sender: TObject);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.DBGridDrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
...
procedure TfrmZaloby_Mlcoch.DBGridEnter(Sender: TObject);
begin
  //FActiveDBGrid:=TDBGrid(Sender);
end;

procedure TfrmZaloby_Mlcoch.DBGridPrepareCanvas(sender: TObject; DataCol: Integer;
  Column: TColumn; AState: TGridDrawState);
begin
  if qrMaster.FieldByName('UZAMCENA').AsInteger=1 then
  begin
...
procedure TfrmZaloby_Mlcoch.DBGridTitleClick(Column: TColumn);
begin
  inherited;
...
procedure TfrmZaloby_Mlcoch.dsMasterDataChange(Sender: TObject; Field: TField);
begin
  inherited;
  //otevri_zpravy;
  info_zpravy;
...
procedure TfrmZaloby_Mlcoch.edFindKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.FormActivate(Sender: TObject);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmZaloby_Mlcoch.FormDestroy(Sender: TObject);
begin
  //if Assigned(FActiveDBGrid) then
  //  FActiveDBGrid.free;
end;

procedure TfrmZaloby_Mlcoch.miPodaciList3Click(Sender: TObject);
var
...
procedure TfrmZaloby_Mlcoch.miArchivovatClick(Sender: TObject);
begin
  ...
  begin
    ...
    ExecSQL('insert into zaloby_mlcoch_archiv /*(ID,VAR_SYMB,JMENO_CP,DATUM_CAS,DLUZNA_CASTKA,JIZDNE,POKUTA,RODNE_CISLO,ULICE,CISLO_DOMU,MESTO,'+
            ...
            '                SPIS_ZNACKA,UHR_SOP,ODVOLANI,JEDNANI,ROZSUDEK,PR_MOC,NAVRH,PRIKAZ,CASTKA,SKONCENO,CISLO,DATUM_UHRADY,ZEMREL,ZAPLATIL_PRED_PODANIM,ZAPLATIL_CASTKA)*/ '+
            ...
            'UHR_SOP,ODVOLANI,JEDNANI,ROZSUDEK,PR_MOC,NAVRH,PRIKAZ,CASTKA,SKONCENO,CISLO,DATUM_UHRADY,ZEMREL,ZAPLATIL_PRED_PODANIM,ZAPLATIL_CASTKA from zaloby_mlcoch where nvl(uzamcena,0)=1)');
    frmProces.ProgressBar1.StepIt;
    frmProces.Repaint;
    frmProces.ShowOnTop;
...
procedure TfrmZaloby_Mlcoch.miArchivZalobClick(Sender: TObject);
begin
...
procedure TfrmZaloby_Mlcoch.miBezGuiduClick(Sender: TObject);
var
  sql_text,temp: string;
  table : TDataSet;
  i : Integer;
...
procedure TfrmZaloby_Mlcoch.miBezUdajuPlatbyClick(Sender: TObject);
var
  sql_text,temp: string;
  table : TDataSet;
  i : Integer;
...
procedure TfrmZaloby_Mlcoch.miDoplnitDatumPlatbyClick(Sender: TObject);
var
  sql_text,temp: string;
  table : TDataSet;
  i : Integer;
...
procedure TfrmZaloby_Mlcoch.miDoplnitUdajeClick(Sender: TObject);
begin
...
procedure TfrmZaloby_Mlcoch.miExportPodaciListClick(Sender: TObject);
begin
  podaci_list_excel(DBGrid,'ZALOBY_MLCOCH');
end;

procedure TfrmZaloby_Mlcoch.miExportPredavaciProtokolClick(Sender: TObject);
begin
  predavaci_protokol_excel(DBGrid,'ZALOBY_MLCOCH');
end;

procedure TfrmZaloby_Mlcoch.miHistorieClick(Sender: TObject);
begin
...
procedure TfrmZaloby_Mlcoch.miImportZalobClick(Sender: TObject);
begin
  //if OpenDialog.Execute then
  //  import_zalob(OpenDialog.FileName);
end;

procedure TfrmZaloby_Mlcoch.miPrubehClick(Sender: TObject);
begin
  prubeh_davky(DBGrid, 'ZALOBY_MLCOCH');
end;

procedure TfrmZaloby_Mlcoch.miVymazatDatumPlatbyClick(Sender: TObject);
var
  sql_text,temp: string;
  table : TDataSet;
  i : Integer;
...
procedure TfrmZaloby_Mlcoch.miVytvoritPrikazClick(Sender: TObject);
begin
...
procedure TfrmZaloby_Mlcoch.miZaplaceneClick(Sender: TObject);
var
  sql_text,temp: string;
  table : TDataSet;
  i : Integer;
...
procedure TfrmZaloby_Mlcoch.miNovyZaznamClick(Sender: TObject);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.miOdemknoutClick(Sender: TObject);
var
  table : TDataSet;
  i: Integer;
begin
...
procedure TfrmZaloby_Mlcoch.miOdemknoutDatumClick(Sender: TObject);
begin
...
procedure TfrmZaloby_Mlcoch.miOdemknoutVseClick(Sender: TObject);
begin
...
procedure TfrmZaloby_Mlcoch.miPodaciList2Click(Sender: TObject);
var
  sql_text,temp: string;
  table : TDataSet;
  i : Integer;
...
procedure TfrmZaloby_Mlcoch.miPodaciListClick(Sender: TObject);
var
  sql_text,temp: string;
  table : TDataSet;
  i : Integer;
...
procedure TfrmZaloby_Mlcoch.miPredavaciProtokolClick(Sender: TObject);
var
  sql_text,temp: string;
  table : TDataSet;
  i : Integer;
...
procedure TfrmZaloby_Mlcoch.miPresunoutZArchivuClick(Sender: TObject);
begin
  if not Assigned(dlgDatum) then
    Application.CreateForm(TdlgDatum,dlgDatum);
  if not Assigned(frmProces) then
  ...
  begin
    ...
    ExecSQL('insert into zaloby_mlcoch /*(ID,VAR_SYMB,JMENO_CP,DATUM_CAS,DLUZNA_CASTKA,JIZDNE,POKUTA,RODNE_CISLO,ULICE,CISLO_DOMU,MESTO,'+
            ...
            '                CU_SOUDU,SPIS_ZNACKA,UHR_SOP,ODVOLANI,JEDNANI,ROZSUDEK,PR_MOC,NAVRH,PRIKAZ,CASTKA,SKONCENO,CISLO,DATUM_UHRADY,ZEMREL,ZAPLATIL_PRED_PODANIM,ZAPLATIL_CASTKA)*/ '+
            '(select ID,VAR_SYMB,JMENO_CP,DATUM_CAS,DLUZNA_CASTKA,JIZDNE,POKUTA,RODNE_CISLO,ULICE,CISLO_DOMU,MESTO,'+
            'OBVOD,PSC,REF_KOD,UZAMCENA,DATUM_IMPORTU,DATUM_UZAMCENI,PL_PRIKAZ,UHRADA,SPLATNOST,SOUD,ZALOBA,NAROK,VS_SOUDU,CU_SOUDU,SPIS_ZNACKA,'+
            'UHR_SOP,ODVOLANI,JEDNANI,ROZSUDEK,PR_MOC,NAVRH,PRIKAZ,CASTKA,SKONCENO,CISLO,DATUM_UHRADY,ZEMREL,ZAPLATIL_PRED_PODANIM,ZAPLATIL_CASTKA from zaloby_mlcoch_archiv where datum_importu=to_date('+Q(dlgDatum.edDatum.Text)+',''DD.MM.YYYY'') or '+Q(dlgDatum.edDatum.Text)+' is null)');
    frmProces.ProgressBar1.StepIt;
    frmProces.Repaint;
    frmProces.ShowOnTop;
...
procedure TfrmZaloby_Mlcoch.miPrijmoutPostuClick(Sender: TObject);
begin
try
...
procedure TfrmZaloby_Mlcoch.miProPrikazClick(Sender: TObject);
var
  sql_text,temp: string;
  table : TDataSet;
  i : Integer;
...
procedure TfrmZaloby_Mlcoch.miSmazatZaznamClick(Sender: TObject);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.miSmlouvaClick(Sender: TObject);
var
  qrTemp : TSQLQuery;
  i : Integer;
...
procedure TfrmZaloby_Mlcoch.miTypyZpravClick(Sender: TObject);
begin
...
procedure TfrmZaloby_Mlcoch.miUpravitZaznamClick(Sender: TObject);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.miUzamknoutClick(Sender: TObject);
var
  table : TDataSet;
  i: Integer;
begin
...
procedure TfrmZaloby_Mlcoch.miUzamknoutDatumClick(Sender: TObject);
begin
    if not Assigned(dlgDatum) then
      Application.CreateForm(TdlgDatum,dlgDatum);
...
procedure TfrmZaloby_Mlcoch.miUzavritVseClick(Sender: TObject);
begin
...
procedure TfrmZaloby_Mlcoch.miVychoziDotazClick(Sender: TObject);
begin
  inherited;
  RadioGroup1.ItemIndex:=0;
end;

procedure TfrmZaloby_Mlcoch.miZavritClick(Sender: TObject);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.miZrusOznaceniClick(Sender: TObject);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.NavigatorBeforeAction(Sender: TObject;
  Button: TDBNavButtonType);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.NavigatorClick(Sender: TObject; Button: TDBNavButtonType);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.Panel1Click(Sender: TObject);
begin

end;

procedure TfrmZaloby_Mlcoch.pcMainPageChanged(Sender: TObject);
begin
  if pcMain.ActivePage=tsSeznam then
    Navigator.DataSource:=dsMaster;
end;

procedure TfrmZaloby_Mlcoch.qrMasterAfterApplyUpdates(Sender: TObject);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.qrMasterAfterPost(DataSet: TDataSet);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.qrMasterBeforeEdit(DataSet: TDataSet);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.qrMasterBeforeInsert(DataSet: TDataSet);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.qrMasterAfterOpen(DataSet: TDataSet);
begin
  //otevri_zpravy;
  info_zpravy;
end;

procedure TfrmZaloby_Mlcoch.qrMasterAfterScroll(DataSet: TDataSet);
var
  s : string;
begin
...
procedure TfrmZaloby_Mlcoch.qrMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TfrmZaloby_Mlcoch.qrMasterNewRecord(DataSet: TDataSet);
begin

end;

procedure TfrmZaloby_Mlcoch.qrZpravyAfterApplyUpdates(Sender: TObject);
begin
  qrZpravy.CommitUpdates;
end;

procedure TfrmZaloby_Mlcoch.qrZpravyAfterPost(DataSet: TDataSet);
begin
  qrZpravy.ApplyUpdates;
end;

procedure TfrmZaloby_Mlcoch.RadioGroup1Click(Sender: TObject);
var
  sql_puv: string;
begin
  qrMaster.Close;
  ...
  qrMaster.Open;
{
  try
    ...
    begin
      ...
      qrMaster.Close;
      qrMaster.SQL.Text:='SELECT * FROM ZALOBY_MLCOCH WHERE NVL(UZAMCENA,0)=1 ORDER BY ID';
      qrMaster.Open;
    ...
    begin
      ...
      //qrMaster.DisableControls;
      qrMaster.Close;
      qrMaster.SQL.Text:='SELECT * FROM ZALOBY_MLCOCH WHERE NVL(UZAMCENA,0)=0 ORDER BY ID';
      qrMaster.Open;
      //qrMaster.EnableControls;
    end;
  except
...
procedure TfrmZaloby_Mlcoch.ToolButton10Click(Sender: TObject);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.ToolButton3Click(Sender: TObject);
begin
  inherited;
end;

procedure TfrmZaloby_Mlcoch.UpdateMasterBeforeInsertSQL(Sender: TObject);
begin

end;

procedure TfrmZaloby_Mlcoch.UpdateMasterBeforeInsertSQLStatement(
...
{
procedure TfrmZaloby_Mlcoch.import_zalob(f: string);
var
  s: TStringList;
  ...
  try
    ...
    begin
      try
        ...
        if ExecSQL_old('SELECT NVL((SELECT COUNT(*) FROM ZALOBY_IMPORT I WHERE EXISTS(SELECT 1 FROM ZALOBY_MLCOCH WHERE VAR_SYMB=I.VAR_SYMB)),0) FROM DUAL')<>'0' then
        begin
          frmProces.ProgressBar1.StepIt;
          frmProces.Repaint;
          frmProces.ShowOnTop;
        ...
        begin
          ExecSql('INSERT INTO ZALOBY_MLCOCH(VAR_SYMB,JMENO_CP,DATUM_CAS,DLUZNA_CASTKA,JIZDNE,POKUTA,RODNE_CISLO,ULICE,CISLO_DOMU,MESTO,OBVOD,PSC,DATUM_IMPORTU)'+
...
procedure TfrmZaloby_Mlcoch.prijmout_postu_ssl;
var
  pop3: TPOP3Send;
  i: integer;
begin
...
procedure TfrmZaloby_Mlcoch.info_zpravy;
begin
  try
    //s:=ExecSQL_old('SELECT 1 FROM DUAL'); //WHERE REF_KOD='''+qrMaster.FieldByName('REF_KOD').AsString+''' AND TYP_ZPRAVY=''1''');

    if StrToInt(ExecSQL_old('SELECT NVL(COUNT(*),0) FROM ZALOBY_ZPRAVY WHERE REF_KOD='''+qrMaster.FieldByName('REF_KOD').AsString+''' AND TYP_ZPRAVY=''1'''))>0 then
    begin
    ...
    if StrToInt(ExecSQL_old('SELECT NVL(COUNT(*),0) FROM ZALOBY_ZPRAVY WHERE REF_KOD='''+qrMaster.FieldByName('REF_KOD').AsString+''' AND TYP_ZPRAVY=''2'''))>0 then
    begin
    ...
    if StrToInt(ExecSQL_old('SELECT NVL(COUNT(*),0) FROM ZALOBY_ZPRAVY WHERE REF_KOD='''+qrMaster.FieldByName('REF_KOD').AsString+''' AND TYP_ZPRAVY=''3'''))>0 then
    begin
    ...
    if StrToInt(ExecSQL_old('SELECT NVL(COUNT(*),0) FROM ZALOBY_ZPRAVY WHERE REF_KOD='''+qrMaster.FieldByName('REF_KOD').AsString+''' AND TYP_ZPRAVY=''4'''))>0 then
    begin
...
procedure TfrmZaloby_Mlcoch.otevri_zpravy;
begin
  {try
